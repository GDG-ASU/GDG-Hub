          ...
          <div className="w-full px-4">
            <div className="relative mx-auto max-w-[525px] overflow-hidden rounded-lg bg-gray-1 px-10 py-16 text-center sm:px-12 md:px-[60px] border border-black ">
              ...
              <form onSubmit={handleSubmit}>
                <InputBox type="email" name="email" placeholder="Email" handleChange={handleChange} />
                <InputBox type="password" name="password" placeholder="Password" handleChange={handleChange} />
                <div className="mb-10">
                  <button
                    type="submit"
              ...
              <p className="mb-6 text-base text-secondary-color font-roboto">Connect With</p>
              <ul className="-mx-2 mb-12 flex justify-between">
                <li className="w-full px-2">
                  <a
                    href="/#"
                    className="flex h-11 items-center justify-center rounded-md bg-[#4064AC] hover:bg-opacity-90 border border-black"
                  >
                ...
                <li className="w-full px-2">
                  <a
                    href="/#"
                    className="flex h-11 items-center justify-center rounded-md bg-[#1C9CEA] hover:bg-opacity-90 border border-black"
                  >
                ...
                <li className="w-full px-2">
                  <a
                    href="/#"
                    className="flex h-11 items-center justify-center rounded-md bg-[#D64937] hover:bg-opacity-90 border border-black"
                  >
              ...
              <p className="text-base text-body-color font-roboto ">
                ...
                <a href="/#" className="text-primary hover:underline font-roboto">
                  Sign Up
                </a>
              </p>
            </div>
